    ...
    <section className='bg-black text-white'>
      <div className='grid grid-cols-1 md:grid-cols-2 md:h-[90vh]'>
        ...
        <div className='p-[10%] md:p-[10%] text-justify scrollElement'>
          <h2 className='text-[22px] md:text-[36px] font-[600] leading-normal pb-[40px] w-[300px] font-source'>Our Story: Bringing Arabian Flavours to the UK/Leicester</h2>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 md:h-[90vh] overflow-hidden'>
        <div className='p-[10%] md:p-[10%] text-justify scrollElement2'>
          <h2 className='text-[22px] md:text-[36px] font-[600] leading-normal pb-[40px] text-left font-source'>Experience Traditional Majlis Dining at Khaleej</h2>
          <div className='w-full max-w-[310px] h-[3px] bg-[#F3F25B]'></div>
