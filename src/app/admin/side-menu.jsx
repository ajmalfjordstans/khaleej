...
export default function SideMenu({ showSection, setShowSection }) {
  return (
    <div className='w-full max-w-[302px] h-full shadow-md border-r-[1px] font-[700] text-[22px]'>
      ...
      <div className={`${showSection == "enquiries" ? "bg-[#ECE7FC]" : "bg-white"} w-full`}>
        <div className='flex gap-[20px] hover:cursor-pointer pl-[30px] py-[20px]'
          onClick={() => setShowSection('enquiries')}
        >
